    ...
    <div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#222;">
      ...
      <div style="padding:24px;">
        ...
        <table style="border-collapse:collapse;width:100%;">
          ...
          <tr><td style="padding:4px 12px 4px 0;color:#666;">Conversion type</td><td style="padding:4px 0;"><strong>${lead.conversionType}</strong></td></tr>
        </table>
  ...
  try {
    await Promise.all([
      resend.emails.send({
        ...
        subject: `New loft conversion lead – ${lead.name} – ${lead.postcode}`,
        html: adminHtml,
      }),
      resend.emails.send({
