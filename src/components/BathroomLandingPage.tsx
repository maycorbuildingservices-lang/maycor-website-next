...
const galleryPhotos = [
  ...
  { src: images.extra23, alt: "View through the doorway into a marble en-suite with double vanity, walk-in shower niche and toilet fitted with protective seal tape", className: "" },
  { src: images.extra24, alt: "Marble bathroom with double vanity, twin backlit mirrors, walk-in niche and toilet ready for handover with seal tape still on", className: "gallery-wide" },
  { src: images.extra25, alt: "Twin wall-hung basins on a floating white vanity unit, each with chrome tap, natural sponge and hand towel", className: "" },
  { src: images.extra26, alt: "Chrome heated towel rail with folded towels beside a frameless glass shower screen and concealed shower valve", className: "" },
  { src: images.extra27, alt: "Twin backlit square mirrors above a marble double-basin vanity, one basin fitted with sponge and towel", className: "" },
  { src: images.extra28, alt: "Two backlit mirrors on a marble wall, one plain-edged and one LED-lit, above a double vanity unit", className: "" },
  { src: images.niche, alt: "Recessed shower niche with tiling", className: "" },
  { src: images.extra29, alt: "Marble alcove window sill styled with a dark vase and reed diffuser, beside a toilet with protective seal tape still fitted", className: "" },
  ...
  { src: images.extra31, alt: "Chrome heated towel rail with mustard and charcoal towels beside a floating shelf styled with diffuser bottles and a sponge, sage-green feature wall", className: "gallery-wide" },
  ...
  { src: images.extra44, alt: "Beige stone-effect tiled bathroom with wall-hung basin, mirrored cabinet, chrome toilet-roll holder and toilet fitted with protective seal tape", className: "" },
  { src: images.extra45, alt: "Bath edge styled with a wooden caddy tray, eucalyptus sprig and bath salts against marble-tiled walls", className: "gallery-wide" },
  { src: images.extra46, alt: "Bath with fold-down glass shower screen and riser-rail shower against marble-tiled walls, styled with a eucalyptus sprig on the bath caddy", className: "" },
  { src: images.extra2, alt: "Marble-tiled bathroom with bath, backlit mirror, wall-hung vanity basin and bath caddy styled with a eucalyptus plant", className: "" },
  { src: images.extra47, alt: "Bath with folding glass shower screen and stone-effect tile splashback, wall-hung basin and toilet visible through the doorway, coral-tinted obscured window glass", className: "" },
  ...
  { src: images.extra51, alt: "Bath with linear stone-effect tile splashback, chrome bath filler and riser-rail shower with glass screen", className: "" },
  ...
  { src: images.extra3, alt: "Teal metro-tiled splashback with wall-hung basin, chrome mixer tap and patterned feature wallpaper", className: "" },
  ...
  { src: images.extra56, alt: "Wall-hung toilet and vanity basin beneath a tall mirror, marble-effect shelf and a city rooftop view through the window", className: "" },
  { src: images.extra57, alt: "Wall-hung toilet, metro-tiled half-wall and vanity basin beneath a mirror with marble-effect shelf and window view over rooftops", className: "" },
  ...
  { src: images.extra60, alt: "Corner glass shower enclosure with white metro tiling, hinged door and linear floor drain", className: "" },
  { src: images.extra61, alt: "Recessed tiled shower niche stocked with shower gels, folding glass screen and rainfall shower head, blue mosaic feature wall visible beyond", className: "" },
  ...
  { src: images.extra64, alt: "Walk-in shower and wall-hung vanity with white metro tiling and black hexagonal floor tiles, toilet reflected in the mirror", className: "" },
  ...
  { src: images.extra6, alt: "View through the doorway into a family bathroom with bath, glass shower screen and sash window over tiled flooring", className: "" },
  ...
  { src: images.extra75, alt: "Teal metro-tiled cloakroom with round brass-framed mirror, patterned feature wallpaper and toilet styled with folded towels", className: "" },
  ...
  { src: images.extra7, alt: "Wall-hung basin, back-to-wall toilet and chrome ladder-style heated towel rail beneath a frosted window", className: "" },
  ...
  { src: images.extra80, alt: "Doorway view into a teal-tiled cloakroom with patterned feature wallpaper, framed art print and dressed window", className: "gallery-wide" },
  { src: images.extra81, alt: "Neutral-tiled cloakroom with wall-hung toilet styled with folded towels, framed abstract prints and a scalloped green mirror", className: "" },
  { src: images.extra82, alt: "Wall-hung basin styled with skincare products beneath a scalloped green-framed mirror, dried pampas grass and framed abstract art alongside", className: "" },
  { src: images.extra8, alt: "Sliding glass shower enclosure with neutral wall tiling, tiled floor and white panelled door beyond", className: "" },
  { src: images.extra83, alt: "Wall-hung basin and toilet with skincare styling, scalloped green mirror and framed abstract print above a stone-effect tiled half-wall", className: "" },
  ...
  { src: images.extra85, alt: "Close-up of a mixed stone-effect mosaic feature strip set between plain wall tiles beside a folding glass bath screen", className: "" },
  ...
  { src: images.extra87, alt: "Doorway view into an en-suite with a scalloped mirror, wood-effect floor tiles and bath with folding glass shower screen", className: "gallery-wide" },
  ...
  { src: images.extra9, alt: "Hinged glass shower door with stone-effect wall tiles, overhead rainfall head and separate handheld shower", className: "" },
  { src: images.extra89, alt: "Wooden bath caddy with brush, striped towel and bottles resting across a bath, riser-rail shower and stone-effect tiling", className: "" },
  { src: images.extra90, alt: "Frameless glass shower screen with concealed thermostatic valve and riser-rail shower against stone-effect wall tiling", className: "" },
  ...
  { src: images.extra92, alt: "Wooden bath caddy with brush and bottles across a bath, beside a round green side table with a reed diffuser and wood-effect floor tiles", className: "" },
