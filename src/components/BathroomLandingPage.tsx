...
const images = {
  ...
  alana1: "/images/gallery-alana-1.jpg",
  alana2: "/images/gallery-alana-2.jpg",
  alana3: "/images/gallery-alana-3.jpg",
  alana4: "/images/gallery-alana-4.jpg",
  alana5: "/images/gallery-alana-5.jpg",
  alana6: "/images/gallery-alana-6.jpg",
...
const galleryPhotos = [
  ...
  // Orange marble-effect ensuite with backlit shower niche and striped-wallpaper double vanity
  ...
  // Alana Johnson's en-suite: brushed brass fittings, stone-effect tile, vessel basin on a floating vanity
  { src: images.alana1, alt: "Corner shower with a brushed brass frame and rainfall head, round countertop basin on a white floating vanity, backlit mirror cabinet and sash window with obscured glazing", className: "gallery-wide" },
  { src: images.alana2, alt: "Brushed brass heated towel rail beside a corner shower with rainfall head, round countertop basin and floating white vanity reflected in the backlit mirror", className: "" },
  { src: images.alana3, alt: "Round countertop basin on a white floating vanity with brushed brass tap, backlit mirror cabinet and an open door onto a hallway with wood flooring", className: "" },
  { src: images.alana4, alt: "White floating vanity with round countertop basin and brushed brass fittings beside a brass-framed corner shower enclosure and obscured-glass window", className: "" },
  { src: images.alana5, alt: "Overview of an en-suite with brass-framed corner shower, round countertop basin, backlit mirror cabinet and wall-hung toilet beneath an obscured-glass window", className: "" },
  { src: images.alana6, alt: "Brass-framed corner shower and round countertop basin reflected in a backlit mirror, wall-hung toilet and heated towel rail alongside", className: "" },
  { src: images.alana7, alt: "Close-up of a brushed brass shower riser rail, handset and rainfall head against stone-effect tiling in a brass-framed shower enclosure", className: "" },
  // Pedestal-style step-up bath and white double vanity ensuite
  ...
  // Jay Jennings, Streatham Hill: black-theme shower enclosure with beige stone-effect tile
  { src: images.extra16, alt: "Black recessed shower niche with LED lighting, black hinged glass door and chrome pull handle", className: "gallery-wide" },
  ...
  // Teal linear-tiled cloakroom with round backlit mirror
  ...
  // Stone-effect corner shower opening onto a bedroom
  ...
  // Walk-in wet-room, stone-effect tiling
  ...
  // Coral-tinted window, folding glass bath screen
  ...
  // Loft en-suite, freestanding bath under a sloped ceiling
  ...
  // White metro tile with black hexagonal floor and marble-effect display shelf
  ...
  // Grey book-matched marble wet-room
  ...
  // Fold-down glass bath screen, mixed stone-effect mosaic
